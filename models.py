...
class Models:
    ...
    # def neural_network_spam_filter1():
    #     model = MLPClassifier(hidden_layer_sizes=(57, 57, 57),
    #                           max_iter=1000)
    #     return model
    #
    # def neural_network_spam_filter1200():
    #     model = MLPClassifier(hidden_layer_sizes=(57, 57, 57),
    #                           max_iter=2000)
    #     return model

    def neural_network_spam_filter2():
        model = MLPClassifier(hidden_layer_sizes=(20, 10, 10, 10, 5),
                              max_iter=1000,
                              learning_rate_init=0.1,
                              momentum=0.8)
        return model

    def neural_network_spam_filter2200():
        model = MLPClassifier(hidden_layer_sizes=(20, 10, 10, 10, 5),
                              max_iter=2000,
                              learning_rate_init=0.1,
                              momentum=0.8)
    ...
    def neural_network_spam_filter3():
        model = MLPClassifier(hidden_layer_sizes=(20, 10, 10, 5),
                              max_iter=1000,
                              learning_rate_init=0.1,
                              momentum=0.85)
        return model

    def neural_network_spam_filter3200():
        model = MLPClassifier(hidden_layer_sizes=(20, 10, 10, 5),
                              max_iter=2000,
                              learning_rate_init=0.1,
                              momentum=0.85)
